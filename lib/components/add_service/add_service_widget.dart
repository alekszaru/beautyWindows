...
class _AddServiceWidgetState extends State<AddServiceWidget> {
  ...
  void initState() {
    ...
    _model.servicePriceController ??= TextEditingController();
                  ...
                  Expanded(
                    child: AuthUserStreamWidget(
                      builder: (context) => FlutterFlowDropDown<String>(
                        ...
                        options: (currentUserDocument?.favoriteCategories
                                ?.toList() ??
                            []),
                        onChanged: (val) =>
                  ...
                  Expanded(
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                      child: TextFormField(
                        controller: _model.servicePriceController,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                          hintText: 'вартість послуги',
                          hintStyle: FlutterFlowTheme.of(context).bodySmall,
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).grayIcon,
                        ...
                        validator: _model.servicePriceControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                    ...
                    onPressed: () async {
                      await ServicesRecord.collection
                          ...
                          .set(createServicesRecordData(
                            title: _model.serviceNameController.text,
                            price: int.tryParse(
                                _model.servicePriceController.text),
