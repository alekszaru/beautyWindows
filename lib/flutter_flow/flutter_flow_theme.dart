...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFFFF5E00);
  late Color accent2 = const Color(0xFF007AFF);
  late Color accent3 = const Color(0xFF00CBBE);
  late Color accent4 = const Color(0xFFFFC700);
  late Color success = const Color(0xFF007E33);
  late Color warning = const Color(0xFFFFC600);
